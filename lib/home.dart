...
/*pages*/
import "package:my_pictrues/views/featured/index.dart";
import "package:my_pictrues/views/newest/index.dart";
import "package:my_pictrues/views/picTabs/index.dart";
import 'package:my_pictrues/views/test/index.dart';
